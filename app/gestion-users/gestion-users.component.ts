...
export class GestionUsersComponent implements OnInit {
  ...
  startAnimationForLineChart(chart: { on: (arg0: string, arg1: (data: any) => void) => void; }){
      ...
      chart.on('draw', function(data: { type: string; element: { animate: (arg0: { d?: { begin: number; dur: number; from: any; to: any; easing: any; }; opacity?: { begin: number; dur: any; from: number; to: number; easing: string; }; }) => void; }; path: { clone: () => { (): any; new(): any; scale: { (arg0: number, arg1: number): { (): any; new(): any; translate: { (arg0: number, arg1: any): { (): any; new(): any; stringify: { (): any; new(): any; }; }; new(): any; }; }; new(): any; }; stringify: { (): any; new(): any; }; }; }; chartRect: { height: () => any; }; }) {
